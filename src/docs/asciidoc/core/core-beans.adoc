...
`EntityCreatedEvent<T>` where `T` is the type of the actual com.spring.entity that got created. For example, you
...
----
	public class EntityCreatedEvent<T> extends ApplicationEvent implements ResolvableTypeProvider {
		...
		public EntityCreatedEvent(T com.spring.entity) {
			super(com.spring.entity);
		}
