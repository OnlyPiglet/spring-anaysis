...
between a persistent com.spring.entity identifier and an com.spring.entity reference. Such an `EntityConverter`
might match only if the target com.spring.entity type declares a static finder method (for example,
