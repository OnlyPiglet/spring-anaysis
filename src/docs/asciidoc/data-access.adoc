...
that is used by the application to obtain an com.spring.entity manager.
...
annotated com.spring.entity classes is supposed to occur. An explicit 'true' value
...
if you want com.spring.entity class scanning to occur.
